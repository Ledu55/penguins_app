...
st.write("This app uses 6 inputs to predict the species of penguin using a model built on the Palmer's Penguin's "
...
st.write("We used machine learning (Random Forest) model to predict the species, the features used "
         "in this prediction are ranked bu relative importance below")
st.image('feature_importance.png')

st.write('Below are the histograms for each continuous variable separated by penguin species. '
         'The vertical line represents your the inputted value')
